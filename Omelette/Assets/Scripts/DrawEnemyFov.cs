...
public class DrawEnemyFov : MonoBehaviour
{
	[SerializeField]
	...
	private float angle_fov = 40;

	private float dist_min = 5.0f;
	private float dist_max = 15.0f;

	private GameObject cone;

	private void Start()
	{
		cone = new GameObject("Cone", typeof(MeshFilter), typeof(MeshRenderer));
		cone.transform.parent = transform;

		meshFilter = cone.GetComponent<MeshFilter>();
